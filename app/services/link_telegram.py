...
from app.services.link_telegram_context import _resource_title_line_score, context_for_115_link
from app.services.link_telegram_hints import (
...
from app.services.link_telegram_message import (
    _add_text_part,
    _collect_dict_texts,
    _safe_attr,
    _text_part,
