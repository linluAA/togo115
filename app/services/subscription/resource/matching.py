...
def matching_results(subscription: dict, results: list[SearchResult], *extra_texts: str) -> list[SearchResult]:
...
def unmatched_results(results: list[SearchResult], matched: list[SearchResult]) -> list[SearchResult]:
