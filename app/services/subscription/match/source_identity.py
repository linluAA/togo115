...
def result_is_fallback_source(result: SearchResult) -> bool:
...
def _result_is_primary_115_resource(result: SearchResult) -> bool:
    ...
    return bool(key and key[0] == "115" and not result_is_fallback_source(result))


def result_priority(result: SearchResult) -> int:
    try:
