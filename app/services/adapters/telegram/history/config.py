...
TELEGRAM_FAST_TOTAL_BUDGET_SECONDS = TELEGRAM_HISTORY_TOTAL_BUDGET_SECONDS  # 70s
TELEGRAM_FAST_QUERY_BUDGET_SECONDS = TELEGRAM_HISTORY_QUERY_BUDGET_SECONDS    # 4s
TELEGRAM_FAST_RECENT_BUDGET_SECONDS = TELEGRAM_HISTORY_RECENT_BUDGET_SECONDS  # 12s
